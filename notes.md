...
https://github.com/computerextra/windows-install
...
* Falls der Patch aus dem Root von `windows-install` ausgeführt werden muss, muss das klar genannt werden.
...
1. Wird der komplette Code auf Fehler überprüft
